...
/**
 * Created by severine on 2020-01-03.
 */
public class NewEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public NewEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            NewEdgeFinder ef = new NewEdgeFinder(tasks, capacity);
            NewEdgeFinder ef_negative = new NewEdgeFinder(negativeTasks, capacity);
