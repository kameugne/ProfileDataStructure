...
public class DefaultEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public DefaultEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            DefaultEdgeFinder ef = new DefaultEdgeFinder(tasks, capacity);
            DefaultEdgeFinder ef_negative = new DefaultEdgeFinder(negativeTasks, capacity);

            int[] estprime = ef.defautEdgefinder();
            int[] estprime_negative = ef_negative.defautEdgefinder();
