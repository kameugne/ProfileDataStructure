...
public class CubicNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public CubicNotFirstConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
        ...
        public void propagate(int evtmask) throws ContradictionException {
            ...
            do
            {
                ...
                CubicNotFirst nf = new CubicNotFirst(tasks, capacity);
                CubicNotFirst nf_negative = new CubicNotFirst(negativeTasks, capacity);
