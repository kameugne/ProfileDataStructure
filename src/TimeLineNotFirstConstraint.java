...
public class TimeLineNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            TimeLineNotFirst nf = new TimeLineNotFirst(tasks, capacity);
            TimeLineNotFirst nf_negative = new TimeLineNotFirst(negativeTasks, capacity);

            int[] estprime = nf.filterWithTimeline();
            int[] estprime_negative = nf_negative.filterWithTimeline();
