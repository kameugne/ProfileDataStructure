...
public class EdgeFinderNewConstraint extends AdjustmentsPropagator {
    ...
    public EdgeFinderNewConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do {
            ...
            EdgeFinderNew ef = new EdgeFinderNew(tasks, capacity);
            EdgeFinderNew ef_negative = new EdgeFinderNew(negativeTasks, capacity);
