...
public class QuadraticNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public QuadraticNotFirstConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
        ...
        public void propagate(int evtmask) throws ContradictionException {
            ...
            do
            {
                ...
                QuadraticNotFirst nf = new QuadraticNotFirst(tasks, capacity);
                QuadraticNotFirst nf_negative = new QuadraticNotFirst(negativeTasks, capacity);

                int[] estprime = nf.Filter();
                int[] estprime_negative = nf_negative.Filter();

                //The makespan is filtered
                if(nf.makespan > makespan.getLB())
                    makespan.updateLowerBound(nf.makespan, this);
