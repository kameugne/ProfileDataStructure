...
public class EdgeFinderConstraintVilim extends AdjustmentsPropagator {
	...
	public EdgeFinderConstraintVilim(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
	...
	public void propagate(int evtmask) throws ContradictionException {
		...
		do
		{
			...
			EdgeFinderVilim ef_negative = new EdgeFinderVilim(negativeTasks, capacity);
